...
class AliSms
{
    ...
    //短信验证码
    const TEMP_VERI_CODE = 'SMS_143866264';
    //告警断行
    const TEMP_ALARM = 'SMS_143866261';
    //开通账户短信
    const TEMP_ACCOUNT = 'SMS_143861259';

    static $acsClient = null;
    static $defaultSignName = '智慧用电安全监控平台';
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAInorEnMCJjK92"; // AccessKeyId

        $accessKeySecret = "4c9rKOLKbLJY7iynlIaTzuZTiKIO5H"; // AccessKeySecret
