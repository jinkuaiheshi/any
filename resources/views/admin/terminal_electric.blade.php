...
@section('content')
    ...
    <div class="site-content">
        ...
        <div class="box box-block bg-white">
            ...
            <div class="row">
                <form class="form-horizontal " method="post" enctype="multipart/form-data" action="{{url('/admin/terminal/electric/year')}}">
                    {{ csrf_field() }}
                    ...
                    <input type="hidden" placeholder="" class="form-control" name="y_projectCode" value="{{$projectCode}}" >
                        <div class="form-group h-a" style="text-align: center">
                            <div class="col-md-4" style="text-align: right">
                                <label for="order" class=" col-form-label " >年份统计电量：</label>
                            </div>
                            <div class="col-md-3">
                ...
                <form class="form-horizontal " method="post" enctype="multipart/form-data" action="{{url('/admin/terminal/electric/month')}}">
                    {{ csrf_field() }}
                    <input type="hidden" placeholder="" class="form-control" name="y_mac" value="{{$mac}}" >
                    <input type="hidden" placeholder="" class="form-control" name="y_projectCode" value="{{$projectCode}}" >
                        <div class="form-group h-a" style="text-align: center">
                            <div class="col-md-4" style="text-align: right">
                                <label for="order" class=" col-form-label " >月统计电量：</label>
                            </div>
                            <div class="col-md-3">
                ...
                <form class="form-horizontal " method="post" enctype="multipart/form-data" action="{{url('/admin/terminal/electric/day')}}">
                    {{ csrf_field() }}
                    <input type="hidden" placeholder="" class="form-control" name="y_mac" value="{{$mac}}" >
                    <input type="hidden" placeholder="" class="form-control" name="y_projectCode" value="{{$projectCode}}" >
                        <div class="form-group h-a" style="text-align: center">
                            <div class="col-md-4" style="text-align: right">
                                <label for="order" class=" col-form-label " >日统计电量：</label>
                            </div>
                            <div class="col-md-3">
                                <div   class="form-group">
