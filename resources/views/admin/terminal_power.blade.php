            ...
            <table class="table table-striped table-bordered dataTable" id="tab" >
                ...
                @foreach($data as $v)
                    <tr>
                        ...
                        <td>{{$v->DeviceName}}</td>
                        <td>
                            <a href="jacascript::void(0)" ><button type="button" class="btn btn-warning w-min-xs  waves-effect waves-light power" data-toggle="modal" data-target="#terminal" data-action="{{$v->id}}">功率详细信息</button></a>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group h-a" style="text-align: center; margin-bottom: 60px;">
                        <label for="name" class=" col-form-label label200" >信号强度：</label>
                        <div  style="float:left; width: 250px;">
                            <input class="form-control" type="text"  name="csq" readonly id="csq" >
    ...
    <script>
        ...
        $(function () {
            $("body").delegate('.table-striped tr', //会为符合条件的现有标签和未来标签都绑定事件
                'click', function () {
                    $.post("{{ url('/admin/ajax/getTerminalPower') }}/"+ $('.table-striped tr').eq($(this).index()+1).find('.power').data('action'),
