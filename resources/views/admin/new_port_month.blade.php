                    ...
                    <div class="list clearfix marginBtm15">
                        ...
                        <div class="listProject clearfix">
                            <div class="row">
                                ...
                                <form class="form-horizontal " method="post" enctype="multipart/form-data" action="{{url('/admin/new/smoke/month/port')}}">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="company_id" value="{{$company_id}}"/>
                                    <div class="form-group h-a" style="text-align: center">
                                        <div class="col-md-4" style="text-align: right">
                                            <label for="order" class=" col-form-label " >选择月报时间：</label>
                                        </div>
                                        <div class="col-sm-1">
