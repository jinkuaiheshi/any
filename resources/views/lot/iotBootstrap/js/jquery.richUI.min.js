...
(function(l) {
	l.fn.richcheckbox = function(options) {
		...
		if("IE8" == l.BrowserVersion()) _Browser = "IE8";
		else _Browser = "otherBrowser";
		...
		if(settings.allBtn) {
			...
			if(checkNum == btnGroup.length) {
				if("IE8" == _Browser) l("#" + _name).addClass("IEChecked");
				else l("#" + _name).addClass("otherBrowserChecked")
			}
		}
	...
	l.fn.richselect = function(options) {
		...
		$('body').on('click', function(event) {
			...
			if(undefined != l(t).attr("class") && -1 != l(t).attr("class").indexOf("richselect")) return;
			else l(".richselect").removeClass('is-open')
		})
	};
